...
CREATE_USER_URL = reverse('users_api:create')
TOKEN_URL = reverse('users_api:token')
ME_URL = reverse('users_api:me')
...
class PrivateUserApiTest(TestCase):
	...
	def test_update_user_profile(self):
		payload = {'username':'new name', 'password':'newpass1234'}
